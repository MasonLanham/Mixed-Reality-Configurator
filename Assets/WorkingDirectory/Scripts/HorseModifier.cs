...
public class HorseModifier : MonoBehaviour
{
    ...
    {
        partChosen = "Mainbody";
        parts = new string[] { "Mainbody", "Tail", "Nose", "Stockings", "Hooves", "Mane", "Eye"};
    ...
    public void UpdateHorse()
    {
        ...
        tracker.recordAction("HOLO-HORSE," + partChosen + "," + colorHexaCodes[getColorIndex()] + "," + texturesChosen[partIndex]);
    }
}
