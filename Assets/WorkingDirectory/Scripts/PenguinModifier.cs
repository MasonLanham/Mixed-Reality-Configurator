...
public class PenguinModifier : MonoBehaviour
{
    ...
    {
        partChosen = "Front";
        parts = new string[] { "Front", "Back", "Flipper", "Feet", "Beak", "Eye Ring", "Eyes"};
    ...
    public void UpdatePenguin()
    {
        ...
        tracker.recordAction("HOLO-PENGUIN," + partChosen + "," + colorHexaCodes[getColorIndex()] + "," + texturesChosen[partIndex]);
    }
}
